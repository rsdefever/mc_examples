...
#            thermo_equil.prop(property_)/n_unitcells,
#            label=pressure
#        )
#        plt.plot(
...
#        )
#    plt.title(f"N_methane, T = {temperature}")
#    plt.xlabel("MC Step")
#    plt.ylabel(f"N_methane/unit cell")
#    plt.legend()
#
...
plt.ylabel("N_methane/unit cell", fontsize=24, labelpad=10)
